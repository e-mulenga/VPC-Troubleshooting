...
exec > >(tee -a "$LOG") 2>&1
echo "=== Lab 03 Web Server Setup: $(date) ==="
...
<head>
  ...
  <title>AWS Broken Labs — Lab 03</title>
  <style>
...
<body>
  <div class="container">
    ...
    <h1>Lab 03 Fixed! ✅</h1>
    <h2>Security Group now allows port 80 — web server reachable.</h2>
    <div class="badge">VPC Lab 03 &mdash; Security Group Port</div>
...
[Unit]
Description=Broken Labs Lab 03 Web Server
...
systemctl is-active --quiet lab-web   && echo "=== ✅ Web server started on port 80 ==="   || { echo "=== ❌ Web server failed ==="; journalctl -u lab-web -n 20; exit 1; }
