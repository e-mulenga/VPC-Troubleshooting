# FIXED LAB — VPC Lab 09: VPC Endpoint
# S3 Gateway Endpoint now associated to PRIVATE route table (CORRECT).
# Single change: route_table_ids = [public.id] → [private.id]
...
resource "aws_vpc_endpoint" "s3" {
  ...
  route_table_ids   = [aws_route_table.private.id]  # ✅ FIXED: private RT
