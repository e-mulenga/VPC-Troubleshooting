...
resource "aws_vpc" "lab" {
  ...
  tags = {
    Name = "brokenlabs-vpc-lab-09-vpc"
  }
}
resource "aws_internet_gateway" "lab" {
  ...
  tags = {
    Name = "brokenlabs-vpc-lab-09-igw"
  }
}
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "brokenlabs-vpc-lab-09-public-subnet"
    Tier = "Public"
  }
}
resource "aws_subnet" "private" {
  ...
  tags = {
    Name = "brokenlabs-vpc-lab-09-private-subnet"
    Tier = "Private"
  }
}
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "brokenlabs-vpc-lab-09-public-rt"
  }
}
...
resource "aws_route_table" "private" {
  ...
  tags = {
    Name = "brokenlabs-vpc-lab-09-private-rt"
  }
}
...
resource "aws_instance" "private" {
  ...
  tags = {
    Name = "brokenlabs-vpc-lab-09-private"
    Tier = "Private"
  }
}
...
resource "aws_vpc_endpoint" "s3" {
  ...
  tags = {
    Name = "brokenlabs-vpc-lab-09-s3-endpoint"
  }
}
