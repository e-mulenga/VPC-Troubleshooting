...
exec > >(tee -a "$LOG") 2>&1
echo "=== Lab 05 Web Server Setup: $(date) ==="
...
<head>
  ...
  <title>AWS Broken Labs — Lab 05</title>
  <style>
...
<body>
  <div class="container">
    ...
    <h1>Lab 05 Fixed! ✅</h1>
    <h2>DNS hostnames enabled — public DNS name now assigned.</h2>
    <div class="badge">VPC Lab 05 &mdash; VPC DNS Settings</div>
...
[Unit]
Description=Broken Labs Lab 05 Web Server
